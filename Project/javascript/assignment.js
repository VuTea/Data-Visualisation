...
function choropleth(){
   ...
   var color3 = d3.scaleQuantize()
	...
	d3.csv("renewable.csv").then(function(d){
	   ...
	   dataset = d;
		   ...
		   //sets the color using min , and d3.max
   ...
   d3.json("states.geojson").then(function(json)
   {
	   ...
	   .style("fill",function(d,i){
			   ...
			   var value=d.properties.year_2015;   //getting the data of 2015 
			   if(value){
	   ...
	   // appeding text for title and for each state 
						   svg.append("text")
						   .attr("class", "energy")
	   ...
	   d3.selectAll("input").on("change", function ()
	   {
		   ...
		   .style("fill",function(d,i){
			   switch(year){
				   ...
				   var value=d.properties.year_2015;   //getting the data of year 2015
				   if(value){
				   ...
				   case "2016":
					   ...
					   var value=d.properties.year_2016;   //getting the data of year 2016
				   ...
				   case "2017":
					   ...
					   var value=d.properties.year_2017;   //getting the data of year 2017
				   ...
				   return "lightgrey" ;   //return grey if there is not data
					   ...
					   var value=d.properties.year_2018;   //getting the data of year 2018 
				   ...
				   return "lightgrey" ;   //return grey if there is not data
					   ...
					   var value=d.properties.year_2019;   //getting the data of 2019 
